...
import { user_login } from "../redux/auth_slice";
                ...
                >
                    ...
                    {error && (
                        <motion.div 
                            ...
                            className="p-4 text-sm text-red-600 dark:text-red-200 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/50 rounded-xl flex items-center gap-3 shadow-lg"
                        >
